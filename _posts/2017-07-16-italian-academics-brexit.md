...
<text x="50%" y="50%" text-anchor="middle" stroke="#fff" stroke-width="1px" dy=".3em" text-shadow="-1px 0 black, 0 1px black, 1px 0 black, 0 -1px black">Maybe</text>
</svg>

<svg width="108" height="108">
<circle cx="54" cy="54" r="54" fill="#FF420E" />
<text x="50%" y="50%" text-anchor="middle" stroke="#fff" stroke-width="1px" dy=".3em" text-shadow="-1px 0 black, 0 1px black, 1px 0 black, 0 -1px black">Yes</text>
</svg>
