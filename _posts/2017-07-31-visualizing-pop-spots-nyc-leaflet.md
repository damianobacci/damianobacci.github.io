...
var marker = L.marker([40.73154, -74.01018]).addTo(map).bindPopup("<h4>Bob Dylan - Blonde on Blonde</h4><br><p>Bob Dylan's BLONDE ON BLONDE (1966) cover photo by Jerry Schatzberg.

Album cover location: 375 West Street at Morton Street, Greenwich Village, New York City. (The building has been replaced.)</p>");
</script>
